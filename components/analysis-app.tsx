...
export default function Home(){
 ...
 return <div className="app analysis-page"><header><a className="landing-brand" href="/" aria-label="Chesslens home"><span aria-hidden="true">♞</span><strong>Chesslens<i>.</i></strong></a><span className="header-section"><ChartNoAxesCombined size={17}/> Analysis board</span><span className="local"><span/> Local workspace</span><button className="import-btn landing-header-cta" onClick={()=>setModal(true)}><Upload size={16}/> Import PGN</button></header>
